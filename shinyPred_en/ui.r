fluidPage(
  ...
  sidebarPanel(
    ...
    sliderInput('eatAT','Maximum number of voles eaten by day by predator', value = 134, min = 0, max = 200, step=1),
    sliderInput('N','Vole density at start (ind./ha)', value = 79,   min = 2, max = 1000,step=1),
